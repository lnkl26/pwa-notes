...
| 5 | 20260413 | IN PROGRESS | Notes can be "archived" but there's no visual indication that archived notes and regular notes are any different, and unarchive button not appearing. |