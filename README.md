...
| 3 | 20260413 | 20260613 | Logging in, doesn't immediately show the user profile. The page must be reloaded in order to show the correct screen. [**FIXED**] Missing `window.location.reload();` in logging in function. |